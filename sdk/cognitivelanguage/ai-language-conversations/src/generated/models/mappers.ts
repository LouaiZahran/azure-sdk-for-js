      ...
      contexts: {
        ...
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ItemizedSummaryContext"
            }
          }
        }
      }
...
export const ConversationSentimentResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationSentimentResult",
    modelProperties: {
      conversationItems: {
        serializedName: "conversationItems",
        required: true,
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ConversationSentimentItemResult"
            }
          }
        }
      }
...
export const ConversationSentimentItemResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationSentimentItemResult",
    modelProperties: {
...
export const TranscriptConversationItem: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      wordLevelTimings: {
        serializedName: "wordLevelTimings",
        type: {
          name: "Sequence",
          element: {
            type: {
      ...
      conversationItemLevelTiming: {
        serializedName: "conversationItemLevelTiming",
        type: {
          name: "Composite",
          className: "ConversationItemLevelTiming"
        }
      }
    }
  }
...
export const RegexKey: coreClient.CompositeMapper = {
...
export const ConversationItemLevelTiming: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationItemLevelTiming",
    modelProperties: {
...
export const ConversationSentimentResultsConversationsItem: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationSentimentResultsConversationsItem",
    modelProperties: {
      ...ConversationSentimentResult.type.modelProperties,
      ...ConversationResultBase.type.modelProperties
    }
  }
};
...
export const ConversationSentimentResults: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationSentimentResults",
    modelProperties: {
      ...PreBuiltResult.type.modelProperties,
      conversations: {
        serializedName: "conversations",
...
export const ItemizedSummaryContext: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ItemizedSummaryContext",
    modelProperties: {
      ...SummaryContext.type.modelProperties,
      conversationItemId: {
        serializedName: "conversationItemId",
        required: true,
        type: {
          name: "String"
        }
...
export const AnalyzeConversationalSentimentTask: coreClient.CompositeMapper = {
  serializedName: "ConversationalSentimentTask",
  type: {
    name: "Composite",
    className: "AnalyzeConversationalSentimentTask",
    uberParent: "TaskIdentifier",
    polymorphicDiscriminator: TaskIdentifier.type.polymorphicDiscriminator,
    modelProperties: {
      ...AnalyzeConversationLROTask.type.modelProperties,
      parameters: {
        ...
        type: {
          name: "Composite",
          className: "ConversationalSentimentTaskParameters"
        }
      }
    }
  }
...
export const AnalyzeConversationSentimentResult: coreClient.CompositeMapper = {
  serializedName: "ConversationalSentimentResults",
  type: {
    name: "Composite",
    className: "AnalyzeConversationSentimentResult",
    uberParent: "TaskState",
    polymorphicDiscriminator: TaskState.type.polymorphicDiscriminator,
    modelProperties: {
      ...AnalyzeConversationJobResult.type.modelProperties,
...
export const ConversationalSentimentTaskParameters: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ConversationalSentimentTaskParameters",
    modelProperties: {
      ...PreBuiltTaskParameters.type.modelProperties,
      predictionSource: {
        serializedName: "predictionSource",
        type: {
          name: "String"
        }
      }
...
export let discriminators = {
  ...
  "TaskState.AnalyzeConversationJobResult": AnalyzeConversationJobResult,
  ...
  "BaseExtraInformation.RegexKey": RegexKey,
  ...
  "TaskIdentifier.ConversationalSentimentTask": AnalyzeConversationalSentimentTask,
  "TaskState.ConversationalPIIResults": AnalyzeConversationPIIResult,
  "TaskState.ConversationalSummarizationResults": AnalyzeConversationSummarizationResult,
  "TaskState.ConversationalSentimentResults": AnalyzeConversationSentimentResult
};
